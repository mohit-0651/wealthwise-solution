...
const About = () => {
  return (
    <section id="about" className="py-20 bg-wealthwise-light" aria-labelledby="about-heading">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 id="about-heading" className="section-title text-center mx-auto after:left-1/2 after:-translate-x-1/2">
            ...
            <div className="order-1 md:order-2 relative">
              <div className="relative rounded-lg overflow-hidden shadow-xl">
                ...
                <img 
                  ...
                  alt="WealthWise financial planning team discussing strategy in a modern office" 
