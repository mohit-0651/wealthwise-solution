        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="animate-on-scroll bg-white p-8 rounded-lg shadow-lg">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-wealthwise-gray mt-1">+971 50 123 4567</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-wealthwise-gray mt-1">info@wealthwise-solutions.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-wealthwise-gray mt-1">Downtown Dubai, UAE</p>
                </div>
              </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-100">
              <h4 className="font-medium text-wealthwise-dark mb-4">Connect With Us</h4>
              <div className="flex space-x-4">
                <a href="#" className="bg-wealthwise-light hover:bg-wealthwise-secondary/20 p-3 rounded-full transition-colors">
                  <svg className="h-5 w-5 text-wealthwise-primary" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
